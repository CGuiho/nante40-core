...
- Always read the files, don't assume they are as they show in your history.
...
My primary language is Typescript, double down on that, unless Go, C# or Python (ordered by preference) would make the task really easy and infrastructure/deploy simple.
I am ready to have another application/service in those languages if needed, that would eventually communicate with the main Typescript application.
